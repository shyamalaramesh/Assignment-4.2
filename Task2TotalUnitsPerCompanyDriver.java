...
public class Task2TotalUnitsPerCompanyDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(Task2TotalUnitsPerCompanyDriver.class);
		...
		job.setMapperClass(Task2TotalUnitsPerCompanyMapper.class);
		
		// Reducer class which has implemenation for the map phase
		job.setReducerClass(Task2TotalUnitsPerCompanyReducer.class);
